...
gdjs.evtsExt__Player__AnimateFallingIntoPortal.asyncCallback22258180 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.75), (runtimeScene) => (gdjs.evtsExt__Player__AnimateFallingIntoPortal.asyncCallback22258180(runtimeScene, eventsFunctionContext, asyncObjectsList)));
}
}
