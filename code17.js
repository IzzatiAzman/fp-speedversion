...
gdjs.Game_32OverCode.GDTimerObjects3= [];
...
}{for(var i = 0, len = gdjs.Game_32OverCode.GDMainMenuObjects1.length ;i < len;++i) {
    gdjs.Game_32OverCode.GDMainMenuObjects1[i].setCenterXInScene(gdjs.evtTools.window.getGameResolutionWidth(runtimeScene) * 0.42);
}
}{for(var i = 0, len = gdjs.Game_32OverCode.GDreplayObjects1.length ;i < len;++i) {
    gdjs.Game_32OverCode.GDreplayObjects1[i].setCenterXInScene(gdjs.evtTools.window.getGameResolutionWidth(runtimeScene) * 0.67);
}
...
gdjs.Game_32OverCode.GDTimerObjects3.length = 0;
