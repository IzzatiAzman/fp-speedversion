...
gdjs.BBQ_32IntroCode.GDTimerObjects1= [];
gdjs.BBQ_32IntroCode.GDTimerObjects2= [];
gdjs.BBQ_32IntroCode.GDTimerObjects3= [];
...
{for(var i = 0, len = gdjs.BBQ_32IntroCode.GDinstructionsObjects1.length ;i < len;++i) {
    ...
    gdjs.BBQ_32IntroCode.GDStartObjects1[i].setCenterXInScene(gdjs.evtTools.window.getGameResolutionWidth(runtimeScene) * 0.9);
}
}}
...
gdjs.BBQ_32IntroCode.GDTimerObjects1.length = 0;
gdjs.BBQ_32IntroCode.GDTimerObjects2.length = 0;
gdjs.BBQ_32IntroCode.GDTimerObjects3.length = 0;
